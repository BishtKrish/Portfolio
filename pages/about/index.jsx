    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 mt-4">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            Passionate creator delivering <span className="text-accent">innovative </span>  digital solutions.
          </motion.h2>
          <motion.p
          ...
          >
           I'm Creative and detail-oriented developer with a passion for designing intuitive websites and solving complex problems. Skilled in Java, React, and building user-friendly applications. Dedicated to continuous learning and innovation.
          </motion.p>
